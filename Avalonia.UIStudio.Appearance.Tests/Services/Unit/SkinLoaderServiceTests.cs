...
public class SkinLoaderServiceTests
{
    ...
    public void LoadSkins_ReturnsSkins_WhenSkinsAreValid()
    {
        ...
        // Act
        var testRoot = "avares://Avalonia.UIStudio.Appearance.Tests/TestAssets/Skins/";
    ...
    public void LoadSkins_HandlesBaseSkinInheritance()
    {
        ...
        assetLoaderMock
            ...
            .Returns(new[]
            {
                new Uri("avares://Avalonia.UIStudio.Appearance/Skins/Base/skin.json"),
                new Uri("avares://Avalonia.UIStudio.Appearance/Skins/Derived/skin.json")
            });
